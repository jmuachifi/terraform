variable "project_id" {
  description = "Google Cloud project ID for the staging environment."
  type        = string
}
...
variable "network_name" {
  ...
  type        = string
  default     = "gke-staging-shared-vpc"
}
...
variable "subnets" {
  ...
  default = [
    {
      name          = "gke-staging-subnet"
      ip_cidr_range = "10.64.0.0/20"
      region        = "us-central1"
      secondary_ip_ranges = [
        {
          range_name    = "gke-staging-pods"
          ip_cidr_range = "10.80.0.0/20"
        },
        {
          range_name    = "gke-staging-services"
...
variable "argocd_host" {
  description = "FQDN for the Argo CD server ingress in staging."
  type        = string
  default     = "argocd.staging.example.com"
}
